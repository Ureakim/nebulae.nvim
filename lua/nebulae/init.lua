...
-- CMP
hi('CmpItemAbbrDeprecated', { fg = c.orange })
...
hi('CmpItemKindKeyword', { fg = c.beige })
hi('CmpItemKindVariable', { fg = c.beige })
hi('CmpItemKindOperator', { fg = c.beige })
hi('CmpItemKindModule', { fg = c.beige })
hi('CmpItemKindEnumMember', { fg = c.beige })
...
hi('CmpItemKindFunction', { fg = c.brown })
hi('CmpItemKindMethod', { fg = c.brown })
hi('CmpItemKindConstructor', { fg = c.brown })
hi('CmpItemKindReference', { fg = c.brown })

hi('CmpItemKindProperty', { fg = c.green })
hi('CmpItemKindField', { fg = c.green })
hi('CmpItemKindEvent', { fg = c.green })
hi('CmpItemKindConstant', { fg = c.green })
hi('CmpItemKindValue', { fg = c.green })
