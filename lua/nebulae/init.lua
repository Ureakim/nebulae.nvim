...
hi('ColorColumn', {bg = c.black10, fg = c.white10})
hi('LineNr', {bg = c.black10, fg = c.white10})
hi('SignColumn', {bg = c.black10, fg = c.white10})
...
hi('Todo', {bg = c.black20, style = 'inverse,bold'})
hi('ErrorMsg', {bg = c.black50, fg = c.red, style = 'bold'})
hi('WarningMsg', {bg = c.black50, fg = c.orange})
